...
//            @Override
//            public void onCancelled(@NonNull DatabaseError databaseError) {
//                Toast.makeText(getActivity(), "Failed to load chats: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
//            }
//        };
//
//        query.addChildEventListener(childEventListener);
...
//                        dataSnapshot.child(NodeNames.NAME).getValue().toString() : "";
//
//                String photoName = userId + ".jpg"; // Assuming photo names are stored as userId.jpg
//
//                ChatListModel chatListModel = new ChatListModel(userId, fullName, photoName, unreadCount, lastMessage, lastMessageTime);
//
//                if (isNew) {
...
//            @Override
//            public void onCancelled(@NonNull DatabaseError databaseError) {
//                Toast.makeText(getActivity(), "Failed to fetch user details: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
//            }
//        });
//    }
//
