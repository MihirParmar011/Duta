        ...
        userTokenRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    ...
                    // 4. Build FCM payload (Removed sending to Firebase Cloud)
                    ...
                    try {
                        ...
                        // 5. Removed the code to send notification to Firebase Cloud
                        Log.d("Notification", "Notification preparation successful");
